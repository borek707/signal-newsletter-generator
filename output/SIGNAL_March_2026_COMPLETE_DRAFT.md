...
**3. Akka pivots to agentic AI platform:** Lightbend (now Akka) launched four new components: Orchestration (multi-agent workflows), Agents (MCP tool support), Memory (durable sharded state), Streaming (real-time AI processing). Included in existing licenses. Positions against LangChain/LlamaIndex with enterprise SLAs for recovery. Claims 3X velocity, ⅓ cost. Risk: BSL license continues pushing users to Apache Pekko fork.
...
* **Stryker4s 0.20 drops:** Mutation testing framework for Scala adds Unix socket support via FS2, claims "slightly improved performance." Also adds Scala 3.8 dialect. Engineers on X debating whether mutation testing is worth the CI time for functional codebases. [Source: X @stryker_mutator, 45 likes]

* **Scala Survey 2026 closes end of March:** VirtusLab collecting data on tooling preferences. Last year showed 92% Scala 3 adoption. This year's hot question: Cats Effect vs ZIO vs stdlib futures. [Source: contributors.scala-lang.org]

* **Hacker News debates MCP backlash:** Perplexity CTO revealed they're ditching MCP for direct APIs. Top HN comment: "MCP solves enterprise auth/governance problems that CLI wrappers can't." 200+ comments. [Source: HN #34728910]

* **"I haven't written code since December" — Andrej Karpathy:** Former Tesla AI director says he now vibes code with LLMs. X thread sparked debate on "post-coding era." 2.5M views. [Source: X @karpathy]
...
**[How Reddit Migrated Comments from Python to Go](https://www.infoq.com/news/2025/11/reddit-comments-go-migration/):** Deep dive into tap-compare testing, sister datastores, and cross-language serialization pitfalls. Essential for any team planning language migrations.

---

### **Repo of the Month**

**[Stryker4s](https://github.com/stryker-mutator/stryker4s):** Mutation testing framework for Scala. Version 0.20 adds Unix socket support, Scala 3.8 dialect, and single-file HTML reports. Good for teams adding mutation testing to CI.

---

### **Paper of the Month**

**[Automating Skill Acquisition of Agentic Repositories](https://arxiv.org/abs/2603.11808):** AI models struggle with complex tasks. This paper shows extracting skills from open-source code improves learning efficiency 40%. Relevant for teams building internal AI coding assistants.
